...
public class DerribarZombieNorte extends SearchAction {	
	...
	public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		if (estadoPlanta.getCantSolesDisponibles() > 0) { //ejecutar la accion solo si el agente tiene soles disponibles (CONDICION DE PARADA)
			...
			if (ubicacion.x > 0) { //Chequeo que el agente no se encuentre en la primera fila (sobre el borde superior) y quiera matar a alguien de una fila negativa
